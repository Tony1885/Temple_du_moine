...
const config: Config = {
    ...
    theme: {
        extend: {
            colors: {
                // Monk Jade (Themed for the class)
                monk: {
                    50: "#f0fdf4",
                    100: "#dcfce7",
                    200: "#bbf7d0",
                ...
                // Deep Raid Night Theme (kept for background)
                void: {
                    900: "#020617",
                    800: "#0a0f1e",
                    700: "#111827",
                ...
                // Epic Violet (kept for accents, maybe Mystic touch?)
                epic: {
                    50: "#f5f3ff",
                    100: "#ede9fe",
                    200: "#ddd6fe",
